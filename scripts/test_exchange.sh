...
cleos push action vapaeetokens configfee '["create","1.0000 ACORN", 1]' -p vapaeetokens@active
cleos push action vapaeetokens configfee '["create","0.1000 TLOS", 2]' -p vapaeetokens@active
...
### cleos push action vapaeetokens order '["alice","buy", "2.5000 CNT", "0.4000 TLOS", "1.0000 TLOS"]' -p alice
### 
### echo "-- 1 buy consumes 2 sell orders --"
