...
# cleos push action eosio.token transfer  '["tom",  "vapaeetokens","0.1234 TLOS","deposit"]' -p tom@active
# cleos push action eosio.token transfer  '["kate", "vapaeetokens","1.0000 TLOS","deposit"]' -p kate@active
# 
